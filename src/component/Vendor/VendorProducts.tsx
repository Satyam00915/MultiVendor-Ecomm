              ...
              myProducts.map((product, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4.5 flex flex-col gap-2 mt-5 text-sm">
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.97 }}
                        className="bg-purple-500 p-2 px-4 rounded-lg hover:bg-purple-700 cursor-pointer active:bg-purple-500"
                      >
                        Edit
                      </motion.button>
                      <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.97 }}
                        className={`p-2 px-4 rounded-lg ${product.verificationStatus === "Approved" ? "bg-green-500" : "bg-gray-500 cursor-not-allowed"}`}
                      >
                      ...
                      {product.verificationStatus === "Rejected" && (
                        <div>
                          ...
                          <p className="mt-1 text-yellow-300">
                            After edit product will be sent for the
                            reverification
                          </p>
                        </div>
                      )}
          ...
          myProducts.map((product, index) => {
            return (
              ...
              >
                ...
                <div className="px-6 py-4.5 text-sm text-center">
                  <span
                    className={`${product.isActive ? "text-green-500" : "text-red-500"}`}
                  >
                    {product?.isActive ? "Active" : "Inactive"}
                ...
                {product.verificationStatus === "Rejected" && (
                  <div>
                    ...
                    {product.rejectedReason || "No reason provided"}
                    <p className="mt-1 text-yellow-300">
                      After edit product will be sent for the reverification
                    </p>
                  </div>
                )}
