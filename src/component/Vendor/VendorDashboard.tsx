...
function VendorDashboard() {
  ...
  const menu = [
    ...
    { id: "orders", label: "User Orders", icon: FaShoppingCart },
  ];
  const renderPage = () => {
    switch (activePage) {
      case "dashboard":
  ...
  return (
    <div className="w-full flex min-h-screen pt-16 bg-linear-to-br from-gray-900 via-black to-gray-900 text-white overflow-x-hidden">
      {/* Mobile Tab bar */}
      <div className="lg:hidden fixed top-16 left-0 w-full bg-slate-950/80 backdrop-blur-xl px-6 py-3.5 flex justify-between items-center border-b border-slate-900/60 z-30">
